...
export class LoginPage implements OnInit {
  ...
  constructor(private restService: ConnectionService, private router: Router) {}
    ...
    const mutation = `
      mutation {
        createUser(userInput: {
          ...
          curp: "${this.addUsers.controls.name.value}",
          rfc: "${this.addUsers.controls.name.value}",
          phone_number: "${this.addUsers.controls.phone_number.value}",
          email: "${this.addUsers.controls.email.value}",
          user_type_id: ${this.addUsers.controls.name.value}
        }) {
          id
          name
          middle_name
